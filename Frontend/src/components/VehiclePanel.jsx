    ...
    <>
        ...
        <div onClick={()=>{
          ...
          className='flex border-3  shadow-xl border-gray-400 active:border-gray-500 bg-white rounded-lg mx-3 items-center justify-between my-3' >
            ...
            <h2 className='w-[23%] px-4 py-6 font-semibold text-md'>₹{props.fare.car}</h2>
        </div>
        ...
        <div onClick={()=>{
          ...
          className='flex border-3  shadow-xl border-gray-400 active:border-gray-500 bg-white rounded-lg mx-3 items-center justify-between my-3' >
            ...
            <h2 className='w-[23%] px-4 py-6 font-semibold text-md'>₹{props.fare.auto}</h2>
        </div>
        ...
        <div onClick={()=>{
          ...
          className='flex border-3 shadow-xl border-gray-400 active:border-gray-500 bg-white rounded-lg mx-3 items-center justify-between my-3' >
            ...
            <h2 className='w-[23%] px-4 py-6 font-semibold text-md '>₹{props.fare.motorcycle}</h2>
        </div>
    </>
  )
}
